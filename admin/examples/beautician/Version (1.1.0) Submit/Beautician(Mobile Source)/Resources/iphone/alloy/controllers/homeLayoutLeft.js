function Controller() {
    ...
    $.__views.homeLayoutLeft.add($.__views.__alloyId64);
    $.__views.bigImgView = Ti.UI.createView({
        width: Ti.UI.SIZE,
        height: Ti.UI.SIZE,
        id: "bigImgView"
    });
    $.__views.__alloyId64.add($.__views.bigImgView);
    ...
    $.__views.__alloyId65.add($.__views.smallImgView1);
    ...
    $.__views.__alloyId65.add($.__views.smallImgView2);
    ...
    $.__views.homeLayoutLeft.add($.__views.__alloyId66);
    ...
    $.__views.__alloyId66.add($.__views.gotoView);
