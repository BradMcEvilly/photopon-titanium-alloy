							...
							<?php
								...
								foreach ($images as $img) {
									...
									echo '<div class="col-md-4" style="height:100"><div class="thumbnail">'.
										...
										'<p class="text-center">'.
										'<a  data-toggle="modal" data-target="#updateDesc" class="detail-img" id="'.$img->id.'" desc="'.$img->description.'" image="'.base_url('uploads/'.$img->path).'">Detail</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.
			...
			<script>
				$(document).ready(function(){
					...
					$('.detail-img').click(function(e){
						...
						var action = "<?php echo site_url("feeds/edit_image/".$feed->id);?>";
					...
					$('.delete-img').click(function(e){
						...
						var id = $(this).attr('id');
						var image = $(this).attr('image');
						var action = '<?php echo site_url('feeds/delete_image/'.$feed->id);?>/' + id + '/' + image;
