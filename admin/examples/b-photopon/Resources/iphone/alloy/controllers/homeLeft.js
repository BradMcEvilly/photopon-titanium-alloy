function Controller() {
    ...
    this.__controllerPath = "homeLeft";
    ...
    var exports = {};
    var __defers = {};
    $.__views.homeLeft = Ti.UI.createView({
    ...
    $.__views.homeLeft && $.addTopLevelView($.__views.homeLeft);
    ...
    $.__views.homeLeft.add($.__views.__alloyId15);
    ...
    $.__views.__alloyId15.add($.__views.bigImgView);
    ...
    $.__views.__alloyId16.add($.__views.smallImgView1);
    ...
    $.__views.__alloyId16.add($.__views.smallImgView2);
    ...
    $.__views.homeLeft.add($.__views.__alloyId17);
    ...
    $.__views.__alloyId17.add($.__views.gotoView);
    ...
    var init = function() {
        if (null != args && null != args.itemsData && args.itemsData.items.length > 0) {
            var scale = {
