...
var loadLanguage = function()
{
	...
	$.btnRegisterLogin.title = Alloy.CFG.Languages.Register;
	...
	$.btnRequest.title = Alloy.CFG.Languages.Request;
};
			...
			var gallery = Titanium.Media.openPhotoGallery({
				...
				success : function(event) {
					var image = event.media;
						...
						dialogBox.loadCustomDialog(Alloy.CFG.languages.appName,Alloy.CFG.languages.chooseImageOnly);
					}
				},
				cancel : function() {
				}
