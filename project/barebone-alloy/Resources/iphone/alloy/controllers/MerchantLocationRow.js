...
function Controller() {
    ...
    this.__controllerPath = "MerchantLocationRow";
    if (arguments[0]) {
        {
    ...
    var $ = this;
    var exports = {};
    $.__views.merchantLocationRow = Ti.UI.createTableViewRow({
        height: 60,
        selectionStyle: "none",
        id: "merchantLocationRow"
    });
    $.__views.merchantLocationRow && $.addTopLevelView($.__views.merchantLocationRow);
    ...
    $.__views.merchantLocationRow.add($.__views.leftContainer);
    ...
    $.__views.merchantLocationRow.add($.__views.rightContainer);
    $.__views.lblName = Ti.UI.createLabel({
        id: "lblName"
    });
    $.__views.rightContainer.add($.__views.lblName);
    $.__views.btnViewLocation = Ti.UI.createView({
    ...
    $.__views.merchantLocationRow.add($.__views.btnViewLocation);
    ...
    $.__views.btnViewLocation.add($.__views.__alloyId38);
    ...
    $.btnViewLocation.addEventListener("click", function() {
    ...
    args.callback && ($.btnViewLocation.visible = false);
    _.extend($, exports);
}
