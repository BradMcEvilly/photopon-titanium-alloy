...
// in simulator we redefine to format for Photopon Developer console
...
{\
	NSString * exceptionName = [@"org.photopon." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.photopon";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIPhotoponNativeItemNone = -1, 
	UIPhotoponNativeItemSpinner = -2,
	UIPhotoponNativeItemProgressBar = -3,
	
	UIPhotoponNativeItemSlider = -4,
	UIPhotoponNativeItemSwitch = -5,
	UIPhotoponNativeItemMultiButton = -6,
	UIPhotoponNativeItemSegmented = -7,
	
	UIPhotoponNativeItemTextView = -8,
	UIPhotoponNativeItemTextField = -9,
	UIPhotoponNativeItemSearchBar = -10,
	
	UIPhotoponNativeItemPicker = -11,
	UIPhotoponNativeItemDatePicker = -12,
	
	UIPhotoponNativeItemInfoLight = -13,
	UIPhotoponNativeItemInfoDark = -14,
	
	UIPhotoponNativeItemDisclosure = -15,
	
	UIPhotoponNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Photopon instances of
