...
function Controller() {
    ...
    this.__controllerPath = "SnapWrapCameraTiVinci";
    ...
    buttonStrokeWidth.addEventListener("click", function(e) {
        paintView.strokeWidth = 10 === paintView.strokeWidth ? 5 : 10;
        e.source.title = 10 === paintView.strokeWidth ? "Decrease Stroke Width" : "Increase Stroke Width";
    });
    ...
    buttonStrokeColorEraser.addEventListener("click", function() {
        paintView.drawMode = Ti.Paint.ERASE;
    });
    win.add(buttonStrokeColorEraser);
    var buttonBezier = Ti.UI.createButton({
        bottom: 70,
        left: 100,
        width: 100,
        height: 30,
    ...
    buttonBezier.addEventListener("click", function() {
        paintView.drawMode = Ti.Paint.CURVE_LINE;
    });
    win.add(buttonBezier);
    var buttonStraight = Ti.UI.createButton({
        bottom: 100,
        left: 100,
        width: 100,
        height: 30,
    ...
    buttonStraight.addEventListener("click", function() {
        paintView.drawMode = Ti.Paint.STRAIGHT_LINE;
    });
    win.add(buttonStraight);
    var buttonCircle = Ti.UI.createButton({
        bottom: 100,
        right: 10,
        width: 100,
        height: 30,
    ...
    var buttonSquare = Ti.UI.createButton({
        bottom: 130,
        right: 10,
        width: 100,
        height: 30,
    ...
    var buttonDynamic = Ti.UI.createButton({
        bottom: 130,
        left: 10,
        width: 100,
        height: 30,
    ...
    buttonDynamic.addEventListener("click", function() {
    ...
    var buttonBlur = Ti.UI.createButton({
        bottom: 160,
        left: 10,
        width: 100,
        height: 30,
    ...
    win.add(buttonBlur);
    var buttonUndo = Ti.UI.createButton({
        bottom: 190,
        left: 10,
        width: 60,
        height: 30,
